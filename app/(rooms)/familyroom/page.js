'use client';
import { FAMILY_ROOM, KING_ROOM } from '@/constants'
        ...
        <div className="container-fluid h-full sm:m-[120px] my-24 mx-2" data-aos="fade-up">
            <div className="container text-center mx-auto">
                <div className="grid grid-cols-3">
                    ...
                    <h1 className='sm:text-3xl text-xl font-playfair text-green'>FAMILY ROOM</h1>
                    <hr className='text-lightdark sm:mt-5 mt-4' />
                </div>
                <p className='pt-3 pb-3 text-dark font-opensans sm:w-3/4 mx-auto text-sm '> Our Family Room is one of the spacious in the city. Inviting and relaxing with separate bathroom shower and bathtub. </p>
            </div>
            ...
            <div className="container h-2/3 sm:mt-10 mt-4 mx-auto">
              ...
              >
                <div>
                    <img src="/rooms/familyroom/carousel/1.jpg" alt='test' className='h-full sm:h-2/3' />
                </div>
                <div>
                    <img src="/rooms/familyroom/carousel/2.jpg" alt='test' className='h-full sm:h-2/3' />
                </div>
                <div>
                    <img src="/rooms/familyroom/carousel/3.jpg" alt='test' className='h-full sm:h-2/3' />
                </div>
                <div>
                    <img src="/rooms/familyroom/carousel/4.jpg" alt='test' className='h-full sm:h-2/3' />
                </div>
                <div>
                    <img src="/rooms/familyroom/carousel/5.jpg" alt='test' className='h-full sm:h-2/3' />
                </div>
              </Carousel>
            </div>
