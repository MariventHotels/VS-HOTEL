    ...
    <>
        <div className="container-fluid h-full sm:m-10 m-2 mt-10 mb-10">
                <div className="container text-center mx-auto">
                    ...
                    <p className='pt-3 pb-3 text-dark font-opensans lg:w-4/6 mx-auto text-sm'>Our guest rooms are infused with uncomplicated comfort and style. Whether you are staying to work or play, rest and revitalize, our guest rooms bring modern conveniences that elevate your lifestyle.</p>
                    <a href="/stay"><button className='bg-green pl-5 pr-5 pt-2 pb-2 text-white mt-2 font-playfair sm:text-xs text-[0.7rem] rounded-sm transition-transform custom-btn'>EXPLORE THE ROOM</button></a>
                </div>
